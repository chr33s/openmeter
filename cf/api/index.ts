...
import { validateRequestId, validateContentType, validateIdempotencyKey } from '@/middleware/validation';
...
app.get('/docs', async (c) => {
  ...
  return c.json({
    ...
    version: '1.0.0',
    description: 'A TypeScript implementation of OpenMeter using Cloudflare Workers',
    endpoints: {
      health: 'GET /health',
      metrics: 'GET /metrics',
      docs: 'GET /docs',
