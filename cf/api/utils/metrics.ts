...
export class ApplicationMetrics {
  ...
  recordDbOperation(
    ...
    this.collector.recordHistogram('db_operation_duration_ms', duration, labels);
  }
  ...
  recordAIOperation(model: string, duration: number, success: boolean): void {
    ...
    this.collector.recordHistogram('ai_operation_duration_ms', duration, labels);
  }
  ...
  recordEventIngestion(
    ...
    this.collector.recordHistogram('event_ingestion_duration_ms', duration, labels);
