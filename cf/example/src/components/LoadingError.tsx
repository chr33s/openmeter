...
export function LoadingSpinner({ size = 'md', className = '' }: LoadingSpinnerProps) {
  ...
  return (
    <div className={`animate-spin inline-block ${sizeClasses[size]} border-[3px] border-current border-t-transparent text-blue-600 rounded-full ${className}`} role="status">
